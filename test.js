...
// const brands = [...new Set([...products.map((product,idx)=>(
// product.brand
// ))])]

// console.log(brands.map((brand,idx)=>(
//     {
//         value:brand,label:brand.split('-').join(' '),checked:false,
//     }
// )))

// let filter={"category":"computer"}
// let queryString = '';
...
// -----> REVERSE WORDS CHARCACTER BY CHARACTER <----

// var myarr=[]
// const str = "this is javascript code"
// const arrStr = str.split(' ')
// const arr = [2,3,4,5,6]
// myarr = arrStr.map((a)=>(//4
...
// let str = "give me the mostcklsnjksajbasn9a sd8ysasy repeated word"; //e
// function findMaxOccuring(str) {
//   let charFreq = {};

//   for (let char of str) {
//     // console.log(char)
//     if (!char.match(/[a-zA-Z]/) || char === " ") continue;
//     char = char.toLowerCase(); //a,b,c,d...z
...
//     if(charFreq[char]>maxCount){
// maxCount=charFreq[char]
// maxOccurenceChar = char
//     }

// }
// return maxOccurenceChar 
// }

// // console.log(findMaxOccuring(str));

// console.log(maxOccurChar(str))



// let filter =  {_sort: 'price', _order: 'asc'}
// let queryString = ''
...
// ________________________________ARRAY.from_________________________
// for making demo array of undefined
// const customArr = Array.from({length:45})
// console.log(customArr)

// ___________________PLAYING WITH OBJECTS ___________________
// const userObj ={firstName:"pratik",surname:"verma",age:23}

// let myarr = {}
// for(item in userObj){
//   // console.log(item)
// myarr[item] = userObj[item]
// }
// console.log(myarr)
// *****************************************************************