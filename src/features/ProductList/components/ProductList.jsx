...
export function ProductList() {
  ...
  // ______________USE EFFECT _____________
  useEffect(() => {
                    ...
                    <div className="mx-auto max-w-2xl px-4 py-8 sm:px-6 sm:py-12 lg:max-w-7xl lg:px-8">
                      ...
                      <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                        {products.map((product, idx) => (
                          <Link key={product.id + idx} to="product-detail">
      ...
      <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
        ...
        <div>
          ...
          >
            ...
            {Array.from({length:Math.ceil(totalItems/ITEMS_PER_PAGE)}).map((el,idx)=>
           ...
           onClick={e=>handlePage(idx+1)}
            aria-current="page"
            className={`relative z-10 cursor-pointer inline-flex items-center ${idx+1===page?'bg-indigo-600  text-white':'text-gray-400'} px-4 py-2 text-sm font-semibold focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600`}
            >
              {idx+1}
            </div>
              )}
